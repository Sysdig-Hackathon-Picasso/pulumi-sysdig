...
{
    [SysdigResourceType("sysdig:Secure/notificationChannelVictorops:NotificationChannelVictorops")]
    public partial class NotificationChannelVictorops : Pulumi.CustomResource
    {
        ...
        public NotificationChannelVictorops(string name, NotificationChannelVictoropsArgs args, CustomResourceOptions? options = null)
            : base("sysdig:Secure/notificationChannelVictorops:NotificationChannelVictorops", name, args ?? new NotificationChannelVictoropsArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private NotificationChannelVictorops(string name, Input<string> id, NotificationChannelVictoropsState? state = null, CustomResourceOptions? options = null)
            : base("sysdig:Secure/notificationChannelVictorops:NotificationChannelVictorops", name, state, MakeResourceOptions(options, id))
        {
        }
