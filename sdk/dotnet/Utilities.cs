...
namespace Pulumi.Sysdig
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Sysdig.version.txt");
    ...
    internal sealed class SysdigResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public SysdigResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
