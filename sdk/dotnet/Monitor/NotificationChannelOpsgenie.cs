...
{
    [SysdigResourceType("sysdig:Monitor/notificationChannelOpsgenie:NotificationChannelOpsgenie")]
    public partial class NotificationChannelOpsgenie : Pulumi.CustomResource
    {
        ...
        public NotificationChannelOpsgenie(string name, NotificationChannelOpsgenieArgs args, CustomResourceOptions? options = null)
            : base("sysdig:Monitor/notificationChannelOpsgenie:NotificationChannelOpsgenie", name, args ?? new NotificationChannelOpsgenieArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private NotificationChannelOpsgenie(string name, Input<string> id, NotificationChannelOpsgenieState? state = null, CustomResourceOptions? options = null)
            : base("sysdig:Monitor/notificationChannelOpsgenie:NotificationChannelOpsgenie", name, state, MakeResourceOptions(options, id))
        {
        }
