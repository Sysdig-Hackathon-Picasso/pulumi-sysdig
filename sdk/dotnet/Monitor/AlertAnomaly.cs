...
namespace Pulumi.Sysdig.Monitor
{
    ...
    public partial class AlertAnomaly : Pulumi.CustomResource
    {
        ...
        public AlertAnomaly(string name, AlertAnomalyArgs args, CustomResourceOptions? options = null)
            : base("sysdig:Monitor/alertAnomaly:AlertAnomaly", name, args ?? new AlertAnomalyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AlertAnomaly(string name, Input<string> id, AlertAnomalyState? state = null, CustomResourceOptions? options = null)
            : base("sysdig:Monitor/alertAnomaly:AlertAnomaly", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static AlertAnomaly Get(string name, Input<string> id, AlertAnomalyState? state = null, CustomResourceOptions? options = null)
        {
            return new AlertAnomaly(name, id, state, options);
        }
    }
