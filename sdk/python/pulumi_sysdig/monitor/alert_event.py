...
__all__ = ['AlertEventArgs', 'AlertEvent']

@pulumi.input_type
class AlertEventArgs:
    def __init__(__self__, *,
                 event_count: pulumi.Input[int],
                 event_name: pulumi.Input[str],
                 event_rel: pulumi.Input[str],
                 source: pulumi.Input[str],
                 trigger_after_minutes: pulumi.Input[int],
                 capture: Optional[pulumi.Input['AlertEventCaptureArgs']] = None,
                 custom_notification: Optional[pulumi.Input['AlertEventCustomNotificationArgs']] = None,
        ...
        :param pulumi.Input[int] event_count: Number of events to match with event_rel.
        :param pulumi.Input[str] event_name: String that matches part of name, tag or the description of Sysdig Events.
        :param pulumi.Input[str] event_rel: Relationship of the event count. It can be `>`, `>=`, `<`, `<=`, `=` or `!=`.
        :param pulumi.Input[str] source: Source of the event. It can be `docker` or `kubernetes`.
        :param pulumi.Input[int] trigger_after_minutes: Threshold of time for the status to stabilize until the alert is fired.
        :param pulumi.Input['AlertEventCaptureArgs'] capture: Enables the creation of a capture file of the syscalls during the event.
        :param pulumi.Input['AlertEventCustomNotificationArgs'] custom_notification: Allows to define a custom notification title, prepend and append text.
        ...
        pulumi.set(__self__, "event_rel", event_rel)
    ...
    def event_count(self) -> pulumi.Input[int]:
        """
    ...
    @event_count.setter
    def event_count(self, value: pulumi.Input[int]):
    ...
    @property
    @pulumi.getter(name="eventRel")
    def event_rel(self) -> pulumi.Input[str]:
        """
        Relationship of the event count. It can be `>`, `>=`, `<`, `<=`, `=` or `!=`.
        """
        return pulumi.get(self, "event_rel")

    @event_rel.setter
    def event_rel(self, value: pulumi.Input[str]):
        pulumi.set(self, "event_rel", value)
    ...
    @property
    @pulumi.getter
    def capture(self) -> Optional[pulumi.Input['AlertEventCaptureArgs']]:
        """
    ...
    @capture.setter
    def capture(self, value: Optional[pulumi.Input['AlertEventCaptureArgs']]):
        pulumi.set(self, "capture", value)

    @property
    @pulumi.getter(name="customNotification")
    def custom_notification(self) -> Optional[pulumi.Input['AlertEventCustomNotificationArgs']]:
        """
    ...
    def custom_notification(self, value: Optional[pulumi.Input['AlertEventCustomNotificationArgs']]):
...
class _AlertEventState:
    def __init__(__self__, *,
                 ...
                 event_rel: Optional[pulumi.Input[str]] = None,
                 multiple_alerts_bies: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 notification_channels: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]] = None,
                 renotification_minutes: Optional[pulumi.Input[int]] = None,
    ...
    @property
    @pulumi.getter(name="eventRel")
    def event_rel(self) -> Optional[pulumi.Input[str]]:
        """
        Relationship of the event count. It can be `>`, `>=`, `<`, `<=`, `=` or `!=`.
        """
        return pulumi.get(self, "event_rel")
    ...
    @event_rel.setter
    def event_rel(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "event_rel", value)
...
class AlertEvent(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 capture: Optional[pulumi.Input[pulumi.InputType['AlertEventCaptureArgs']]] = None,
                 custom_notification: Optional[pulumi.Input[pulumi.InputType['AlertEventCustomNotificationArgs']]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 enabled: Optional[pulumi.Input[bool]] = None,
                 event_count: Optional[pulumi.Input[int]] = None,
                 event_name: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['AlertEventCaptureArgs']] capture: Enables the creation of a capture file of the syscalls during the event.
        :param pulumi.Input[pulumi.InputType['AlertEventCustomNotificationArgs']] custom_notification: Allows to define a custom notification title, prepend and append text.
        :param pulumi.Input[str] description: The description of Monitor alert.
        :param pulumi.Input[bool] enabled: Boolean that defines if the alert is enabled or not. Defaults to true.
        :param pulumi.Input[int] event_count: Number of events to match with event_rel.
        :param pulumi.Input[str] event_name: String that matches part of name, tag or the description of Sysdig Events.
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param AlertEventArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AlertEventArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AlertEventArgs.__new__(AlertEventArgs)

            __props__.__dict__["capture"] = capture
            __props__.__dict__["custom_notification"] = custom_notification
            __props__.__dict__["description"] = description
            __props__.__dict__["enabled"] = enabled
            if event_count is None and not opts.urn:
                raise TypeError("Missing required property 'event_count'")
            __props__.__dict__["event_count"] = event_count
            ...
            if event_rel is None and not opts.urn:
                raise TypeError("Missing required property 'event_rel'")
            __props__.__dict__["event_rel"] = event_rel
        ...
        super(AlertEvent, __self__).__init__(
            'sysdig:Monitor/alertEvent:AlertEvent',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            team: Optional[pulumi.Input[int]] = None,
            trigger_after_minutes: Optional[pulumi.Input[int]] = None,
            version: Optional[pulumi.Input[int]] = None) -> 'AlertEvent':
        """
        ...
        __props__ = _AlertEventState.__new__(_AlertEventState)
        ...
        return AlertEvent(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter
    def capture(self) -> pulumi.Output[Optional['outputs.AlertEventCapture']]:
        """
        Enables the creation of a capture file of the syscalls during the event.
        """
        return pulumi.get(self, "capture")
    ...
    @property
    @pulumi.getter(name="customNotification")
    def custom_notification(self) -> pulumi.Output[Optional['outputs.AlertEventCustomNotification']]:
        """
        Allows to define a custom notification title, prepend and append text.
        """
        return pulumi.get(self, "custom_notification")
    ...
    @property
    @pulumi.getter(name="eventCount")
    def event_count(self) -> pulumi.Output[int]:
        """
        Number of events to match with event_rel.
        """
        return pulumi.get(self, "event_count")
    ...
    @property
    @pulumi.getter(name="eventRel")
    def event_rel(self) -> pulumi.Output[str]:
        """
        Relationship of the event count. It can be `>`, `>=`, `<`, `<=`, `=` or `!=`.
        """
        return pulumi.get(self, "event_rel")
