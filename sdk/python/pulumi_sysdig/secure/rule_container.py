...
__all__ = ['RuleContainerArgs', 'RuleContainer']

@pulumi.input_type
class RuleContainerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] containers: List of containers to match.
        :param pulumi.Input[str] description: The description of Secure rule. By default is empty.
        :param pulumi.Input[bool] matching: Defines if the image name matches or not with the provided list. Default is true.
...
class RuleContainer(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[RuleContainerArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        ## Import
        ...
        :param str resource_name: The name of the resource.
        :param RuleContainerArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(RuleContainerArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = RuleContainerArgs.__new__(RuleContainerArgs)
        ...
        super(RuleContainer, __self__).__init__(
            'sysdig:Secure/ruleContainer:RuleContainer',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[str]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            version: Optional[pulumi.Input[int]] = None) -> 'RuleContainer':
        """
        ...
        __props__ = _RuleContainerState.__new__(_RuleContainerState)
        ...
        return RuleContainer(resource_name, opts=opts, __props__=__props__)
