...
__all__ = ['RuleProcessArgs', 'RuleProcess']

@pulumi.input_type
class RuleProcessArgs:
...
class RuleProcess(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(RuleProcessArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = RuleProcessArgs.__new__(RuleProcessArgs)
        ...
        super(RuleProcess, __self__).__init__(
            'sysdig:Secure/ruleProcess:RuleProcess',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            processes: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            version: Optional[pulumi.Input[int]] = None) -> 'RuleProcess':
        """
        ...
        __props__ = _RuleProcessState.__new__(_RuleProcessState)
        ...
        return RuleProcess(resource_name, opts=opts, __props__=__props__)
