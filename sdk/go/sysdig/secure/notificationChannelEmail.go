...
func NewNotificationChannelEmail(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("sysdig:Secure/notificationChannelEmail:NotificationChannelEmail", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNotificationChannelEmail(ctx *pulumi.Context,
	...
	var resource NotificationChannelEmail
	err := ctx.ReadResource("sysdig:Secure/notificationChannelEmail:NotificationChannelEmail", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
