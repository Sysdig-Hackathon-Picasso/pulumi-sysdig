...
func NewNotificationChannelOpsgenie(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("sysdig:Monitor/notificationChannelOpsgenie:NotificationChannelOpsgenie", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNotificationChannelOpsgenie(ctx *pulumi.Context,
	...
	var resource NotificationChannelOpsgenie
	err := ctx.ReadResource("sysdig:Monitor/notificationChannelOpsgenie:NotificationChannelOpsgenie", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
