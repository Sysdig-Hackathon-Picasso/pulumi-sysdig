...
export class NotificationChannelWebhook extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'sysdig:Monitor/notificationChannelWebhook:NotificationChannelWebhook';
    ...
    constructor(name: string, argsOrState?: NotificationChannelWebhookArgs | NotificationChannelWebhookState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            inputs["additionalHeaders"] = state ? state.additionalHeaders : undefined;
            ...
            inputs["additionalHeaders"] = args ? args.additionalHeaders : undefined;
