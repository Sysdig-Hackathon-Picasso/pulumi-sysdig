...
export class AlertDowntime extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AlertDowntimeState, opts?: pulumi.CustomResourceOptions): AlertDowntime {
        return new AlertDowntime(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sysdig:Monitor/alertDowntime:AlertDowntime';

    /**
     * Returns true if the given object is an instance of AlertDowntime.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AlertDowntime {
     ...
     */
    constructor(name: string, args: AlertDowntimeArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AlertDowntimeArgs | AlertDowntimeState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AlertDowntimeState | undefined;
            ...
            inputs["entitiesToMonitors"] = state ? state.entitiesToMonitors : undefined;
            ...
            inputs["triggerAfterPct"] = state ? state.triggerAfterPct : undefined;
            inputs["version"] = state ? state.version : undefined;
        } else {
            const args = argsOrState as AlertDowntimeArgs | undefined;
            ...
            inputs["entitiesToMonitors"] = args ? args.entitiesToMonitors : undefined;
            ...
            inputs["triggerAfterPct"] = args ? args.triggerAfterPct : undefined;
        ...
        super(AlertDowntime.__pulumiType, name, inputs, opts);
    }
}
