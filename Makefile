...
prepare::
	...
	if [[ "${OS}" != "Darwin" ]]; then \
		sed -i 's,github.com/pulumi/pulumi-sysdig,${REPOSITORY},g' provider/go.mod; \
...
build_sdks:: install_plugins provider build_python build_go # build all the sdks
